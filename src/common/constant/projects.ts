  ...
  projects: [
    {
      ...
      description:
        'Designed and launched a comprehensive language learning application to preserve ' +
        'the endangered Blackfoot language, deploying across Web, iOS, and Android platforms. ' +
        'This app was developed using Flutter and Dart, ensuring a uniform user experience. ' +
        'It integrates advanced conversational AI by leveraging GPT-4 Language Learning Models (LLMs), ' +
        'which provide personalized learning feedback and interactive conversation practice, enhancing ' +
    ...
    },
    {
      ...
      description:
        'A sophisticated video analysis tool designed to detect shot boundaries in AVI video files. ' +
        'Utilizing twin-comparison algorithms, it identifies hard cuts and gradual transitions, ' +
        'offering precise editing cues. The system includes a user-friendly GUI for easy interaction.',
    ...
    },
    {
      ...
      slug: 'cbirs',
      description:
        'A Content-Based Image Retrieval system that utilizes intensity and color-code histograms ' +
        'to rank and retrieve images based on visual similarity. Featuring a dynamic GUI, the system ' +
        'enables users to interactively refine search results through relevance feedback, optimizing ' +
        'the retrieval accuracy.',
      image: '/images/projects/ImageRetrievalSys.jpeg',
      link_github:
        'https://github.com/harikac27/Content-based-image-retrieval-system',
